...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO DSC", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "WNELdM2xi3Uowc8K12UVkaNHfrRZkjYpab")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	walletID := "WNELdM2xi3Uowc8K12UVkaNHfrRZkjYpab"
	account := &openwallet.AssetsAccount{Alias: "mainnetDSC", WalletID: walletID, Required: 1, Symbol: "DSC", IsTrust: true}
...
func TestWalletManager_CreateAddress(t *testing.T) {
	...
	walletID := "WNELdM2xi3Uowc8K12UVkaNHfrRZkjYpab"
	accountID := "J3Jqz4Q5EGPjZeof8XEgdzVT8QDbsAbjgHB5y1WtkZBz"
...
func TestWalletManager_GetAddressList(t *testing.T) {
	...
	walletID := "WNELdM2xi3Uowc8K12UVkaNHfrRZkjYpab"
	//accountID := "J3Jqz4Q5EGPjZeof8XEgdzVT8QDbsAbjgHB5y1WtkZBz"
	accountID := "B7HqFnoQBrA1eKTPTywvwS29hJc7bJhtLzS1Drd2CYXU"
...
/*
	...
	addresses:
		DGiunXUEDPUY2TtSDzCYcX2su6TrRroCya
		DJ7Jd36EzwtRGpyBxQDkxpBbeueRaLAidJ

	walletID := "WNELdM2xi3Uowc8K12UVkaNHfrRZkjYpab"
	accountID := "B7HqFnoQBrA1eKTPTywvwS29hJc7bJhtLzS1Drd2CYXU"

	addresses:
		DEUa4qSt6htJcuvQaZzpoL3YE64nyGCoMg
*/